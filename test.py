...
def get_parser():
    ...
    parser.add_argument('--config', type=str, default='config/iSAID/iSAID_split0_resnet50.yaml', help='config file') # coco/coco_split0_resnet50.yaml
...
def validate(val_loader, model, val_seed):
            ...
            if ((i + 1) % round((test_num/100)) == 0):
                logger.info('Test: [{}/{}] '
                            ...
                            'Accuracy {accuracy:.4f}.'.format(iter_num* args.batch_size_val, test_num,
                                                            ...
                                                            accuracy=accuracy))
            # print("s_input: " + str(s_input.shape))
    ...
    class_miou_b = class_miou_b*1.0 / (len(class_intersection_meter_b) - len(target_b[target_b==0]))
