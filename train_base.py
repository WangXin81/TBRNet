...
def get_parser():
    ...
    parser.add_argument('--config', type=str, default='config/pascal/iSAID_split0_vgg_base.yaml', help='config file')
...
# ----------------------  DATASET  ----------------------
    ...
    if args.data_set == 'pascal' or args.data_set == 'coco' or args.data_set == 'DLRSD':
